...
/*   Updated: 2024/11/28 14:51:25 by prambaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	char *(str2) = ft_strjoin(stash[fd], str);
	if (str2[0] == '\0')
		return (ft_liberator(str, stash[fd], str2));
	free(stash[fd]);
	stash[fd] = ft_takeright(str2);
	free(str);
